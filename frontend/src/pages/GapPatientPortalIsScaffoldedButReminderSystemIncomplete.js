...
/**
 * Gap/CFS Feature Page: Patient portal is scaffolded but reminder system incomplete.
 * Slug: patient-portal-is-scaffolded-but-reminder-system-incomplete
 * Backend: /api/gap-patient-portal-is-scaffolded-but-reminder-system-incomplete
 */
export default function PatientPortalIsScaffoldedButReminderSystemIncompletePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-patient-portal-is-scaffolded-but-reminder-system-incomplete', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Patient portal is scaffolded but reminder system incomplete.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Patient portal is scaffolded but reminder system incomplete.</p>
