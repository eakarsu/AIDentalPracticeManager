...
/**
 * Gap/CFS Feature Page: No intraoral camera integration.
 * Slug: no-intraoral-camera-integration
 * Backend: /api/gap-no-intraoral-camera-integration
 */
export default function NoIntraoralCameraIntegrationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-intraoral-camera-integration', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No intraoral camera integration.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No intraoral camera integration.</p>
