...
/**
 * Gap/CFS Feature Page: Insurance claim automation
 * Slug: insurance-claim-automation
 * Backend: /api/cf-insurance-claim-automation
 */
export default function InsuranceClaimAutomationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-insurance-claim-automation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Insurance claim automation</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Auto-generate claims; predict claim approval likelihood; flag likely denials preemptively.</p>
