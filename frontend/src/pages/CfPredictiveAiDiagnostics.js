...
/**
 * Gap/CFS Feature Page: Predictive AI diagnostics
 * Slug: predictive-ai-diagnostics
 * Backend: /api/cf-predictive-ai-diagnostics
 */
export default function PredictiveAiDiagnosticsPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-predictive-ai-diagnostics', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Predictive AI diagnostics</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Computer vision analysis of x-rays; suggest diagnoses and treatment options.</p>
