...
/**
 * Gap/CFS Feature Page: No insurance-eligibility verification adapter.
 * Slug: no-insurance-eligibility-verification-adapter
 * Backend: /api/gap-no-insurance-eligibility-verification-adapter
 */
export default function NoInsuranceEligibilityVerificationAdapterPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-insurance-eligibility-verification-adapter', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No insurance-eligibility verification adapter.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No insurance-eligibility verification adapter.</p>
